# CSE 220: Signals and Linear Systems - Term Project

## Overview
As part of the BUET CSE 220 Sessional curriculum, students undertake an applied term project exploring signal processing and linear systems concepts.

- **Weight in Assessment**: Part of the 70% assignments score.
- **Assignment Timeline**: Week 6–7 (Topic Selection and Project Assignment).
