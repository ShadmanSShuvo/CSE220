...
def main():
    ...
    # Since x[n - n0] = A*cos(Omega0*(n - n0) + phi) = A*cos(Omega0*n + phi - Omega0*n0)
    ...
    # Part B: Given an arbitrary phase change, find the best matching time shift
    ...
    print(f"[Part B] Best matching integer shift in [{k_min},{k_max}] is k={best_k} with MSE={best_err:.10f}")
